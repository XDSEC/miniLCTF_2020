...
import org.abc.A.G.ShopDisplayItemDespawnEvent;
import org.abc.A.G.ShopDisplayItemSpawnEvent;
...
public class RealDisplayItem extends DisplayItem {
    ...
    public boolean checkIsShopEntity(@NotNull Entity entity) {
        ...
        return checkIsGuardItemStack(((Item) entity).getItemStack());
    }
    ...
    public boolean removeDupe() {
        ...
        for (Entity entity : item.getNearbyEntities(1.5, 1.5, 1.5)) {
            ...
            if (!eItem.getUniqueId().equals(displayUUID)) {
                if (checkIsTargetShopDisplay(eItem.getItemStack(), this.shop)) {
                    Util.debugLog(
    ...
    public void spawn() {
        ...
        this.guardedIstack = createGuardItemStack(this.originalItemStack, this.shop);
        this.item =
